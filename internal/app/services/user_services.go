...
//	stats.TotalQuestionsDoneCount = 0
//	stats.TotalEasyCount = 0
//	stats.TotalMediumCount = 0
//	stats.TotalHardCount = 0
//	stats.EasyDoneCount = 0
//	stats.MediumDoneCount = 0
//	stats.HardDoneCount = 0
//
//	if allQuestionsCount, ok := statsData["allQuestionsCount"].([]interface{}); ok {
//		for _, item := range allQuestionsCount {
//			countInfo := item.(map[string]interface{})
...
//func (s *UserService) GetLeetcodeStats(userID string) (*models.LeetCodeStats, error) {
//
//	leetcodeStats := models.LeetCodeStats{}
//
//	// placeholder implementation
//
//	return nil, nil
